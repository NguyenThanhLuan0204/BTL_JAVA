...
public class LoginController {
	...
	public String showHomePage(Model model) {
		...
		dsSanPham.add(new SanPham("Sản phẩm 1", "/resources/user/img/featured/loa1.webp",
				"mo ta san pham", null, 100000, 100000, 50000,
				0, dsChiTietLoaiSP.subList(0, 1)));
		dsSanPham.add(new SanPham("Sản phẩm 2", "/resources/user/img/featured/loa2.webp",
				"mo ta san pham", null, 100000, 100000, 50000,
				0, dsChiTietLoaiSP.subList(0, 1)));
		dsSanPham.add(new SanPham("Sản phẩm 3", "/resources/user/img/featured/tainghe1.webp",
				"mo ta san pham", null, 100000, 100000, 50000,
				0, dsChiTietLoaiSP.subList(1, 2)));
		dsSanPham.add(new SanPham("Sản phẩm 4", "/resources/user/img/featured/tainghe2.webp",
				"mo ta san pham", null, 100000, 100000, 50000,
				0, dsChiTietLoaiSP.subList(1, 2)));
		dsSanPham.add(new SanPham("Sản phẩm 5", "/resources/user/img/featured/mic1.webp",
				"mo ta san pham", null, 100000, 100000, 50000, 0, dsChiTietLoaiSP.subList(2, 3)));
		dsSanPham
				.add(new SanPham("Sản phẩm 6", "/resources/user/img/featured/mic2.webp",
						"mo ta san pham", null, 100000, 100000, 50000, 0, dsChiTietLoaiSP.subList(2, 3)));
		dsSanPham
				.add(new SanPham("Sản phẩm 7",  "/resources/user/img/featured/phukien1.webp",
						"mo ta san pham", null, 100000, 100000, 50000, 0, dsChiTietLoaiSP.subList(3, 4)));
		dsSanPham
				.add(new SanPham("Sản phẩm 8", "/resources/user/img/featured/phukien2.webp",
						"mo ta san pham", null, 100000,100000, 50000, 0, dsChiTietLoaiSP.subList(3, 4)));
		dsSanPham
				.add(new SanPham("Sản phẩm 9", "/resources/user/img/featured/mixer1.webp",
						"mo ta san pham", null, 100000,100000, 50000, 0, dsChiTietLoaiSP.subList(4, 5)));
